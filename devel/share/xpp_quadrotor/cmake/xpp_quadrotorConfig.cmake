...
if("TRUE" STREQUAL "TRUE")
  set(xpp_quadrotor_SOURCE_PREFIX /home/junette/catkin_ws/src/xpp/robots/xpp_quadrotor)
  set(xpp_quadrotor_DEVEL_PREFIX /home/junette/catkin_ws/devel)
  ...
  set(xpp_quadrotor_INSTALL_PREFIX /home/junette/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xpp_quadrotor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/junette/catkin_ws/src/xpp/robots/xpp_quadrotor/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND xpp_quadrotor_EXPORTED_TARGETS ${${xpp_quadrotor_dep}_EXPORTED_TARGETS})
endforeach()
