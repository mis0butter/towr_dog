...
if("TRUE" STREQUAL "TRUE")
  set(xpp_states_SOURCE_PREFIX /home/junette/catkin_ws/src/xpp/xpp_states)
  set(xpp_states_DEVEL_PREFIX /home/junette/catkin_ws/devel)
  ...
  set(xpp_states_INSTALL_PREFIX /home/junette/catkin_ws/install)
...
if(NOT "/home/junette/catkin_ws/src/xpp/xpp_states/include;/usr/include/eigen3 " STREQUAL " ")
  set(xpp_states_INCLUDE_DIRS "")
  set(_include_dirs "/home/junette/catkin_ws/src/xpp/xpp_states/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xpp_states' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/junette/catkin_ws/src/xpp/xpp_states/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT xpp_states_NUM_DUMMY_TARGETS)
      set(xpp_states_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::xpp_states::wrapped-linker-option${xpp_states_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR xpp_states_NUM_DUMMY_TARGETS "${xpp_states_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::xpp_states::wrapped-linker-option${xpp_states_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND xpp_states_LIBRARIES "${interface_target_name}")
